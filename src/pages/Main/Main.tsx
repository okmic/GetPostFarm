    ...
    <div className="flex flex-col items-center justify-start">
      ...
      <section className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 pt-8 sm:pt-24 lg:pt-28 pb-12 sm:pb-24 text-center">
        ...
        <div className="relative">
          ...
          <h1 className="text-2xl sm:text-5xl lg:text-7xl font-thin text-white tracking-[-0.03em] leading-[1.1] sm:leading-[1.05] mb-3 sm:mb-6">
            Выращивайте
            <br />
      ...
      <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 pb-12 sm:pb-28">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-5 gap-1.5 sm:gap-3">
          {[
            ...
            <div key={i} className="rounded-xl sm:rounded-2xl bg-white/[0.02] border border-white/[0.04] p-2 sm:p-4 text-center">
              <span style={{ color: item.color }} className="text-lg sm:text-2xl mb-1 sm:mb-2 block">{item.icon}</span>
              <p className="text-[10px] sm:text-xs text-white/80 font-medium mb-0.5">{item.name}</p>
              <p className="text-[9px] sm:text-[11px] text-white/30 mb-1.5 sm:mb-3">{item.limit}/день</p>
